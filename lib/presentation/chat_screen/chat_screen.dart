...
class _ChatScreenState extends State<ChatScreen> with TickerProviderStateMixin {
      ...
      child: Column(
        ...
        children: [
          Container(
            width: 54,
            height: 54,
            decoration: BoxDecoration(color: item.color.withOpacity(0.1), borderRadius: BorderRadius.circular(16)),
            child: Icon(item.icon, color: item.color, size: 26),
          ),
          const SizedBox(height: 6),
          Text(
            item.label,
            style: TextStyle(fontSize: 12, fontWeight: FontWeight.w600, color: Color(0xFF1A1A2E)),
          ),
          Text(
            item.sublabel,
    ...
    return Padding(
      ...
      child: Center(
        child: Container(
          ...
          child: Text(
            label,
            style: TextStyle(fontSize: 11, color: Color(0xFF4A7FA5), fontWeight: FontWeight.w600, letterSpacing: 0.3),
          ),
        ),
      ),
    );
      ...
      children: [
        ...
        if (hasCaption)
          Padding(
            ...
            child: Text(message.content, style: TextStyle(fontSize: 14, color: Color(0xFF1A1A2E), height: 1.4)),
          ),
      ],
    );
  }
            ...
            child: Column(
              ...
              children: [
                Text(
                  ...
                  maxLines: 2,
                  overflow: TextOverflow.ellipsis,
                  style: TextStyle(fontSize: 13, fontWeight: FontWeight.w600, color: Color(0xFF1A1A2E), height: 1.3),
                ),
                const SizedBox(height: 4),
                if (isUploading)
                  Text(
  ...
  Widget _buildHyperlinkText(String text, bool isMe) {
    ...
    if (matches.isEmpty) {
      return RichText(
        text: TextSpan(
          style: TextStyle(fontSize: 15, color: const Color(0xFF1A1A2E), height: 1.45),
    ...
    return RichText(
      text: TextSpan(
        style: const TextStyle(fontSize: 15, color: Color(0xFF1A1A2E), height: 1.45),
        children: spans,
      ),
    );
  }
          ...
          children: [
            ClipRRect(
              ...
              child: Container(
                ...
                child: Center(child: Icon(Icons.movie_outlined, color: Colors.white.withOpacity(0.3), size: 48)),
              ),
            ),
            if (isUploading)
              SizedBox(
                  ...
                  Expanded(
                    child: Container(
                      ...
                      child: TextField(
                        ...
                        minLines: 1,
                        maxLines: 4,
                        style: TextStyle(color: Color(0xFF1A1A2E), fontSize: 15),
                        decoration: InputDecoration(
