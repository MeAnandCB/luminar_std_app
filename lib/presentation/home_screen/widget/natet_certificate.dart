...
class _NactetBannerState extends State<NactetBanner> with TickerProviderStateMixin {
  ...
  List<Color> _ll(List<Color> a, List<Color> b) => List.generate(a.length, (i) => _lc(a[i], b[i]));
  ...
  void initState() {
    ...
    _cycleCtrl = AnimationController(vsync: this, duration: const Duration(milliseconds: 4000))
      ..addListener(() {
    ...
    _blinkCtrl = AnimationController(vsync: this, duration: const Duration(milliseconds: 1800))..repeat(reverse: true);
        ...
        child: InkWell(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(colors: _bg, begin: Alignment.topLeft, end: Alignment.bottomRight),
              borderRadius: BorderRadius.circular(16),
              border: Border.all(color: _border, width: 1.5),
              boxShadow: [BoxShadow(color: _shadow.withOpacity(0.2), blurRadius: 16, offset: const Offset(0, 4))],
            ),
            ...
            child: Row(
              children: [
                      ...
                      Opacity(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            boxShadow: [BoxShadow(color: _dot.withOpacity(0.6), blurRadius: 5)],
                          ),
                        ),
                      ),
                    ],
                ...
                Container(
                  ...
                  height: 32,
                  decoration: BoxDecoration(
                    gradient: LinearGradient(colors: _icon, begin: Alignment.topLeft, end: Alignment.bottomRight),
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    gradient: LinearGradient(colors: _badge, begin: Alignment.topLeft, end: Alignment.bottomRight),
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        '${widget.pendingCount}',
                        style: TextStyle(fontSize: 14, fontWeight: FontWeight.w700, color: _num, height: 1),
                      ),
                      Text(
                        'Pending',
                        style: TextStyle(
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    gradient: LinearGradient(colors: _btn, begin: Alignment.topLeft, end: Alignment.bottomRight),
                    borderRadius: BorderRadius.circular(10),
                    boxShadow: [
                      BoxShadow(color: _shadow.withOpacity(0.38), blurRadius: 10, offset: const Offset(0, 3)),
                    ],
                  ),
                  child: Row(
                    mainAxisSize: MainAxisSize.min,
