class AttandanceDashBoardModel {
  String? status;
  String? message;
  Dashboard? dashboard;
  DateTime? timestamp;

  AttandanceDashBoardModel({
    this.status,
    this.message,
    this.dashboard,
    this.timestamp,
  ...
  factory AttandanceDashBoardModel.fromJson(Map<String, dynamic> json) =>
      AttandanceDashBoardModel(
        status: json["status"],
...
class Achievements {
  ...
  factory Achievements.fromJson(Map<String, dynamic> json) => Achievements(
    perfectAttendance: json["perfect_attendance"],
    highPerformers: json["high_performers"],
    coursesWithGrades: json["courses_with_grades"],
  );
...
class Certificates {
  ...
  factory Certificates.fromJson(Map<String, dynamic> json) => Certificates(
...
class OverallMetrics {
  ...
  factory OverallMetrics.fromJson(Map<String, dynamic> json) => OverallMetrics(
    totalCoursesEnrolled: json["total_courses_enrolled"],
    completedCourses: json["completed_courses"],
    activeCourses: json["active_courses"],
    completionRate: json["completion_rate"],
    averageAttendancePercentage: json["average_attendance_percentage"],
    averageCompletionPercentage: json["average_completion_percentage"],
  );
...
class BatchDetails {
  ...
  factory BatchDetails.fromJson(Map<String, dynamic> json) => BatchDetails(
    ...
    totalCurrentBatches: json["total_current_batches"],
    ...
    completedBatchesCount: json["completed_batches_count"],
  );
...
class Topic {
  ...
  Topic({
    ...
    this.name,
    this.description,
    this.minimumAttendanceDuration,
    this.createdAt,
    this.updatedAt,
  });
  ...
  factory Topic.fromJson(Map<String, dynamic> json) => Topic(
    ...
    name: json["name"],
    description: json["description"],
    minimumAttendanceDuration: json["minimum_attendance_duration"],
  ...
  Map<String, dynamic> toJson() => {
    ...
    "name": name,
    "description": description,
    "minimum_attendance_duration": minimumAttendanceDuration,
...
class EnrollmentDetailsSummary {
  ...
  factory EnrollmentDetailsSummary.fromJson(Map<String, dynamic> json) =>
      EnrollmentDetailsSummary(
        ...
        onHoldEnrollments: json["on_hold_enrollments"],
        droppedEnrollments: json["dropped_enrollments"],
      );
...
class EmiInformation {
  ...
  factory EmiInformation.fromJson(Map<String, dynamic> json) => EmiInformation(
    hasEmiEnrollments: json["has_emi_enrollments"] == null
        ? []
        : List<dynamic>.from(json["has_emi_enrollments"]!.map((x) => x)),
    totalPendingEmis: json["total_pending_emis"],
    totalOverdueEmis: json["total_overdue_emis"],
    nextEmiDueDate: json["next_emi_due_date"],
    nextEmiAmount: json["next_emi_amount"],
    totalPendingEmiAmount: json["total_pending_emi_amount"],
...
class Overview {
  ...
  factory Overview.fromJson(Map<String, dynamic> json) => Overview(
    ...
    totalFeesAmount: json["total_fees_amount"],
    paymentCompletionPercentage: json["payment_completion_percentage"],
...
class PaymentSummary {
  ...
  factory PaymentSummary.fromJson(Map<String, dynamic> json) => PaymentSummary(
    ...
    totalAmountPaidViaTransactions: json["total_amount_paid_via_transactions"],
    averagePaymentAmount: json["average_payment_amount"]?.toDouble(),
...
class Engagement {
  ...
  factory Engagement.fromJson(Map<String, dynamic> json) => Engagement(
    daysSinceAdmission: json["days_since_admission"],
    referralsMade: json["referrals_made"],
...
class Financial {
  ...
  factory Financial.fromJson(Map<String, dynamic> json) => Financial(
    ...
    paymentCompletion: json["payment_completion"],
    pendingEmis: json["pending_emis"],
    overdueEmis: json["overdue_emis"],
  );
...
class EntActivity {
  ...
  factory EntActivity.fromJson(Map<String, dynamic> json) => EntActivity(
    uid: json["uid"],
    type: json["type"],
    title: json["title"],
    description: json["description"],
    ...
    performedBy: fullNameValues.map[json["performed_by"]]!,
  ...
  Map<String, dynamic> toJson() => {
    ...
    "performed_by": fullNameValues.reverse[performedBy],
...
class EnrollmentInfo {
  ...
  factory EnrollmentInfo.fromJson(Map<String, dynamic> json) => EnrollmentInfo(
    enrollmentNumber: enrollmentNumberValues.map[json["enrollment_number"]]!,
    batchName: batchNameValues.map[json["batch_name"]]!,
  );

  Map<String, dynamic> toJson() => {
    "enrollment_number": enrollmentNumberValues.reverse[enrollmentNumber],
    "batch_name": batchNameValues.reverse[batchName],
  };
}

enum BatchName { MEARN_MAR_2026_GRACESON_B1_COCHIN }

final batchNameValues = EnumValues({
  "MEARN Mar 2026 Graceson B1 Cochin":
      BatchName.MEARN_MAR_2026_GRACESON_B1_COCHIN,
});

enum EnrollmentNumber { ENR2026032390 }

final enrollmentNumberValues = EnumValues({
  "ENR2026032390": EnrollmentNumber.ENR2026032390,
});

enum FullName { ANAND, NM_BTESTD, SYSTEM }

final fullNameValues = EnumValues({
  "Anand": FullName.ANAND,
  "NMBtestd": FullName.NM_BTESTD,
...
class RecentActivitiesSummary {
  ...
  factory RecentActivitiesSummary.fromJson(Map<String, dynamic> json) =>
      RecentActivitiesSummary(
        ...
        activitiesToday: json["activities_today"],
        activitiesThisWeek: json["activities_this_week"],
        pendingFollowUps: json["pending_follow_ups"],
      );
...
class ReferralInfo {
  ...
  factory ReferralInfo.fromJson(Map<String, dynamic> json) => ReferralInfo(
    ...
    totalReferralsMade: json["total_referrals_made"],
  );
...
class UpcomingActivitiesSummary {
  ...
  factory UpcomingActivitiesSummary.fromJson(Map<String, dynamic> json) =>
      UpcomingActivitiesSummary(
        ...
        emiPayments: json["emi_payments"],
        courseCompletions: json["course_completions"],
        demoExpiries: json["demo_expiries"],
